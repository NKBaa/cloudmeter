...
ALTER TABLE pricing_items ADD COLUMN active boolean NOT NULL DEFAULT true;
...
RETURNS uuid LANGUAGE sql STABLE AS $$
    ...
    WHERE pi.active AND pi.code=p_code AND pi.unit=p_unit AND pv.effective_at<=p_at
